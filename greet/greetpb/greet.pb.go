...
type GreetRequest struct {
	...
	Greetiung *Greeting `protobuf:"bytes,1,opt,name=greetiung,proto3" json:"greetiung,omitempty"`
}
...
func (x *GreetRequest) GetGreetiung() *Greeting {
	if x != nil {
		return x.Greetiung
	}
	return nil
...
func (x *GeetResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GeetResponse) ProtoMessage() {}

func (x *GeetResponse) ProtoReflect() protoreflect.Message {
	mi := &file_greet_greetpb_greet_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GeetResponse.ProtoReflect.Descriptor instead.
func (*GeetResponse) Descriptor() ([]byte, []int) {
	return file_greet_greetpb_greet_proto_rawDescGZIP(), []int{2}
}

func (x *GeetResponse) GetResult() string {
	if x != nil {
		return x.Result
	}
	return ""
...
func (x *GreetWithDeadlinesRequest) Reset() {
	*x = GreetWithDeadlinesRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *GreetWithDeadlinesRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GreetWithDeadlinesRequest) ProtoMessage() {}

func (x *GreetWithDeadlinesRequest) ProtoReflect() protoreflect.Message {
	mi := &file_greet_greetpb_greet_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GreetWithDeadlinesRequest.ProtoReflect.Descriptor instead.
func (*GreetWithDeadlinesRequest) Descriptor() ([]byte, []int) {
	return file_greet_greetpb_greet_proto_rawDescGZIP(), []int{9}
}

func (x *GreetWithDeadlinesRequest) GetGreeting() *Greeting {
	if x != nil {
		return x.Greeting
	}
	return nil
...
func (x *GreetWithDeadlinesResponse) Reset() {
	*x = GreetWithDeadlinesResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GreetWithDeadlinesResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GreetWithDeadlinesResponse) ProtoMessage() {}

func (x *GreetWithDeadlinesResponse) ProtoReflect() protoreflect.Message {
	mi := &file_greet_greetpb_greet_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GreetWithDeadlinesResponse.ProtoReflect.Descriptor instead.
func (*GreetWithDeadlinesResponse) Descriptor() ([]byte, []int) {
	return file_greet_greetpb_greet_proto_rawDescGZIP(), []int{10}
}

func (x *GreetWithDeadlinesResponse) GetResult() string {
	if x != nil {
		return x.Result
	}
	return ""
...
var file_greet_greetpb_greet_proto_rawDesc = []byte{
	...
	0x65, 0x65, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x2d, 0x0a, 0x09, 0x67, 0x72,
	0x65, 0x65, 0x74, 0x69, 0x75, 0x6e, 0x67, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0f, 0x2e,
	0x67, 0x72, 0x65, 0x65, 0x74, 0x2e, 0x47, 0x72, 0x65, 0x65, 0x74, 0x69, 0x6e, 0x67, 0x52, 0x09,
	0x67, 0x72, 0x65, 0x65, 0x74, 0x69, 0x75, 0x6e, 0x67, 0x22, 0x26, 0x0a, 0x0c, 0x47, 0x65, 0x65,
	...
	0x74, 0x22, 0x44, 0x0a, 0x15, 0x47, 0x72, 0x65, 0x65, 0x74, 0x4d, 0x61, 0x6e, 0x79, 0x74, 0x69,
	...
	0x67, 0x47, 0x72, 0x65, 0x65, 0x74, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x2b, 0x0a,
	...
	0x6e, 0x65, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x2b, 0x0a, 0x08, 0x67, 0x72,
	0x65, 0x65, 0x74, 0x69, 0x6e, 0x67, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x67,
	0x72, 0x65, 0x65, 0x74, 0x2e, 0x47, 0x72, 0x65, 0x65, 0x74, 0x69, 0x6e, 0x67, 0x52, 0x08, 0x67,
	0x72, 0x65, 0x65, 0x74, 0x69, 0x6e, 0x67, 0x22, 0x34, 0x0a, 0x1a, 0x47, 0x72, 0x65, 0x65, 0x74,
	0x57, 0x69, 0x74, 0x68, 0x44, 0x65, 0x61, 0x64, 0x6c, 0x69, 0x6e, 0x65, 0x73, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x32, 0x89, 0x03,
	...
	,
	...
	0x65, 0x74, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x18, 0x2e, 0x67, 0x72, 0x65, 0x65,
...
var file_greet_greetpb_greet_proto_goTypes = []interface{}{
	...
	(*GeetResponse)(nil),               // 2: greet.GeetResponse
	...
	(*GreetWithDeadlinesRequest)(nil),  // 9: greet.GreetWithDeadlinesRequest
	(*GreetWithDeadlinesResponse)(nil), // 10: greet.GreetWithDeadlinesResponse
}
var file_greet_greetpb_greet_proto_depIdxs = []int32{
	0,  // 0: greet.GreetRequest.greetiung:type_name -> greet.Greeting
	...
	0,  // 4: greet.GreetWithDeadlinesRequest.greeting:type_name -> greet.Greeting
	1,  // 5: greet.GreetService.Greet:input_type -> greet.GreetRequest
	9,  // 6: greet.GreetService.GreetWithDeadlines:input_type -> greet.GreetWithDeadlinesRequest
	...
	2,  // 10: greet.GreetService.Greet:output_type -> greet.GeetResponse
	10, // 11: greet.GreetService.GreetWithDeadlines:output_type -> greet.GreetWithDeadlinesResponse
...
func file_greet_greetpb_greet_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_greet_greetpb_greet_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GreetWithDeadlinesRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_greet_greetpb_greet_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GreetWithDeadlinesResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
